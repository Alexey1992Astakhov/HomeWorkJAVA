...
import Exception_final_task.exception.IncorrectBirthdayFormatException;
import Exception_final_task.exception.SexFormatException;
import Exception_final_task.exception.PhoneFormatException;
...
public class DataHandler {
    ...
    private boolean checkInput(String[] array) {
        ...
        // проверка формата указанного пола пользователя
