package Exception_final_task;

import Exception_final_task.services.DataServices;
import Exception_final_task.services.DataWriterToFile;
...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Введите ФИО, дату рождения, телефон и пол (через разделитель 'пробел'): ");
