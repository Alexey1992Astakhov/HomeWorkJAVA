...
public class Task01 {
    ...
    public static void main(String[] args) {
        ...
        printArray(resultArr1);
        System.out.println("Частное");
        printArray(resultArr2);
    }

    /* Метод принимает на вход два массива, вычисляет разность элементов на одинаковых индексах и
    ...
    /* Метод принимает на вход два массива, вычисляет частное элементов на одинаковых индексах и
    записывает результат в новый массив
     */
    private static int[] divideArrays(int[] firstArray, int[] secondArray) {
        int size = checkArrays(firstArray, secondArray);
        int[] resultArray = new int[size];
    ...
    */
    private static int[] fillArray() {
        ...
        if (scanner.hasNextInt()) {   // проверка на корректность ввода от пользователя
